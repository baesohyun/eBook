<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    %>
 <!--    <div id="menu">
		<input type="button" class="btn btn-secondary" value="공지사항"/><br><br>
		<input type="button" class="btn btn-secondary" value="문의사항"/><br><br>
		<input type="button" class="btn btn-secondary" value="고객센터"/><br><br>
	<div  class="btn btn-secondary"  style="width: 90px;height: 150px">고객센터<br> 02-2582-3349 <br><br>연중무휴</div>
	</div> -->
